...
enum VectorType
{
    ...
    TC7_Key_128_Nonce_64_Rounds_8,
    TC7_Key_128_Nonce_64_Rounds_12,
    TC7_Key_128_Nonce_64_Rounds_20,
    TC7_Key_256_Nonce_64_Rounds_8,
    TC7_Key_256_Nonce_64_Rounds_12,
    TC7_Key_256_Nonce_64_Rounds_20,
    /* TC8: Random key and nonce */
    TC8_Key_128_Nonce_64_Rounds_8,
    TC8_Key_128_Nonce_64_Rounds_12,
    TC8_Key_128_Nonce_64_Rounds_20,
    TC8_Key_256_Nonce_64_Rounds_8,
    TC8_Key_256_Nonce_64_Rounds_12,
...
enum VectorGroup
{
    ...
    TC7, /* TC7: Sequence patterns in key and nonce*/
...
uint8_t Key_128[NUM_VECTOR_GROUP][KEY_SIZE_128] = {
    ...
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* TC3 */

    {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}, /* TC4 */

    {0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55}, /* TC5 */

    {0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xaa,0xbb,0xcc,0xdd,0xee,0xff}, /* TC7 */
...
uint8_t Key_256[NUM_VECTOR_GROUP][KEY_SIZE_256] = {
    ...
    {0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55, /* TCC5 */
...
uint8_t Nonce_64[NUM_VECTOR_GROUP][NONCE_SIZE_64] = {
    ...
    {0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* TC3 */

    {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}, /* TC4 */

    {0xaa,0xaa,0xaa,0xaa,0xaa,0xaa,0xaa,0xaa}, /* TC5 */

    {0x0f,0x1e,0x2d,0x3c,0x4b,0x59,0x68,0x77}, /* TC7 */

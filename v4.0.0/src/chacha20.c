...
static void quarter_round(uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint32_t *ChachaBlock)
{
...
void generate_chacha_cipher_key(uint8_t *Key, uint64_t Counter, uint64_t Nonce, uint32_t Rounds,
                                uint8_t *OutCipherStream)
{
	...
	//Shuffling rounds and generating key block ---------------------------------
